 ...
 * @date 2019.10.18
 */
public class IlpfFilterProcessor extends ImageProcessor {

    public static int[][] lowFilter(MyComplex[][] complexes, int radius){
    ...
    public static void process(BufferedImage srcImg, BufferedImage trgImg, BufferedImage newSrcImg, int radius){
        ...
        // 计算半径内功率
        double percent = FourierUtils.calcPowerPercent(dest, radius);
        System.out.println("功率为 = " + percent);
